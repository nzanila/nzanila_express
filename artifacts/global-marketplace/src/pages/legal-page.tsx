...
/** Terms of Service + Privacy Policy. One page, two sections, linked from every signup form. */
  ...
  return (
    <div className="min-h-screen bg-[#f7f8fa]">
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
        <button onClick={() => (window.history.length > 1 ? window.history.back() : setLocation('/'))} className="mb-6 inline-flex items-center gap-1 text-sm font-semibold text-gray-600 hover:text-gray-900">
        ...
        <section id="terms" className="mt-8 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-8">
        ...
        <section id="privacy" className="mt-6 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-8">
