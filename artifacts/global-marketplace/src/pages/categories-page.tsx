  ...
  return <AppShell activeTab="market">
    <div className="min-h-screen min-w-0 overflow-x-hidden bg-background">
      <div className="flex min-w-0">
        <aside className="sticky top-[56px] h-[calc(100vh-56px-56px)] w-[158px] flex-shrink-0 overscroll-contain overflow-y-auto border-r border-border bg-card [scrollbar-color:#d1d5db_transparent] [scrollbar-width:thin] sm:w-[205px] lg:h-[calc(100vh-56px)] lg:w-[240px]" aria-label="Product categories">
          <nav className="space-y-0.5 py-2">
            {categoriesLoading && <p className="p-3 text-[11px] text-muted-foreground">Loading…</p>}
            {categoriesError && <p className="p-3 text-[11px] text-red-600">Unavailable</p>}
